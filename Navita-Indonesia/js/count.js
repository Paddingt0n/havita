function CountBox() {
    ...
    if (amount < 0) {
        out =
            ...
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + hours1 + " </div><div class='timer-num'>" + hours2 + "</div></div><div class='timer-name'> JAM</div></div>" +
            "<div class='timer-separate'></div>" +
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + mins1 + " </div><div class='timer-num'>" + mins2 + "</div></div><div class='timer-name'>MENIT</div></div>" +
            "<div class='timer-separate'></div>" +
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + secs1 + " </div><div class='timer-num'>" + secs2 + "</div></div><div class='timer-name'>DETIK</div>";
